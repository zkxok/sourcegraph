...
func (r *searcher) alertForNoResolvedRepos(ctx context.Context) (*SearchAlert, error) {
...
func (r *searcher) alertForOverRepoLimit(ctx context.Context) (*SearchAlert, error) {
	alert := &SearchAlert{
...
func (r *searcher) alertForMissingRepoRevs(missingRepoRevs []*RepositoryRevisions) *SearchAlert {
...
func omitQueryFields(r *searcher, field string) string {
