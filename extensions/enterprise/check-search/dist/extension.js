 ...
 */
function memoizeAsync(func, resolver) {
  const cache = new Map();
...
const queryGraphQL = memoizeAsync(async ({
  query,
  vars
}) => {
...
},{"sourcegraph":"../../../../node_modules/sourcegraph/src/index.js"}],"demo0.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.registerDemo0 = registerDemo0;
...
function startDiagnostics() {
  ...
  subscriptions.add((0, _rxjs.from)(sourcegraph.workspace.rootChanges).pipe((0, _operators.startWith)(void 0), (0, _operators.map)(() => sourcegraph.workspace.roots), (0, _operators.switchMap)(async () => {
    const resp = await (0, _util.queryGraphQL)({
      query: `
    ...
    const fileMatches = resp.data && resp.data.__typename === 'Query' && resp.data.search && resp.data.search.results && resp.data.search.results.results ? resp.data.search.results.results.filter(r => r.__typename === 'FileMatch') : [];
    return fileMatches.map(({
      file
    }) => {
      const uri = `git://${file.repository.name}?${file.commit.oid}#${file.path}`;
      const diagnostics = findMatchRanges(file.content).map(range => ({
        message: 'Found foo',
        range,
        severity: sourcegraph.DiagnosticSeverity.Hint
      }));
      return [new URL(uri), diagnostics];
    });
  })).subscribe(entries => {
...
},{"sourcegraph":"../../../../node_modules/sourcegraph/src/index.js","rxjs":"../../../../node_modules/rxjs/_esm5/index.js","rxjs/operators":"../../../../node_modules/rxjs/_esm5/operators/index.js","./util":"util.ts"}],"extension.ts":[function(require,module,exports) {
"use strict";
...
var _demo = require("./demo0");

function activate(ctx) {
  ctx.subscriptions.add((0, _demo.registerDemo0)());
}
},{"./demo0":"demo0.ts"}]},{},["extension.ts"], null)
